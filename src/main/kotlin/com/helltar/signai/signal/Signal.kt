...
import com.helltar.signai.network.NetworkClient
...
class Signal(private val apiUrl: String, private val phoneNumber: String, private val networkClient: NetworkClient) {
    ...
    suspend fun receiveEach(ignoreAttachments: Boolean = true, onReceive: suspend (Receive.Response) -> Unit) {
        ...
        networkClient.webSocket(url) { responseJson ->
    ...
    suspend fun replyToMessage(text: String, replyAuthor: String, replyId: Long, recipient: String): String {
        ...
        return networkClient.post(url, body = body)
    }
    ...
    suspend fun showTypingIndicator(recipient: String, show: Boolean = true) {
        ...
        if (show) networkClient.put(url, body) else networkClient.delete(url, body)
    }
