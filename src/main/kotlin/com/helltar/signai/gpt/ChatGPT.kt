...
class ChatGPT(private val apiKey: String, private val model: String, private val networkClient: NetworkClient) {
    ...
    suspend fun sendPrompt(messages: List<Chat.Message>): String {
        ...
        val responseJson = networkClient.post(url, headers, body)
